export class Util {
    ...
    static midi_letter_pitches: { a: 21, b: 23, c: 12, d: 14, e: 16, f: 17, g: 19 };
    static midi_pitches_letter = { '12': 'c', '13': 'c#', '14': 'd', '15': 'd#', '16': 'e', '17': 'f',
        '18': 'f#', '19': 'g', '20': 'g#', '21': 'a', '22': 'a#', '23': 'b' };
    static midi_flattened_notes = { 'a#': 'bb', 'c#': 'db', 'd#': 'eb', 'f#': 'gb', 'g#': 'ab' };
     ...
     */
    static noteFromMidiPitch(n, iReturnFlattened) {
        let octave = 0, noteNum = n, noteName;
        const returnFlattened = iReturnFlattened || false;
        if (n > 23) {
     ...
     */
    static str2Bytes(str, finalBytes) {
        if (finalBytes) {
     ...
     */
    static translateTickTime(ticks) {
